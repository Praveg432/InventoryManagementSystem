...
class IMS
{
	...
	static
	{
		try
		{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/IMS","root","crossbow");		//importing drivers
		}
		catch(Exception e)
		{
	...
	public static boolean login()throws SQLException		//login Method
	{
		...
		PreparedStatement pst=con.prepareStatement("select * from login");		//object declaration to pass SQL select query
